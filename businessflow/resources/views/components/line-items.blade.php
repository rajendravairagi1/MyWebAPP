        ...
        <script>
            function lineItemsForm(products, initialItems, initialDiscount, initialTaxRate) {
                return {
                    products,
                    commonItems: [
                        { id: 're-booking', name: 'Earnest Money Deposit' },
                        { id: 're-down-payment', name: 'Down Payment' },
                        { id: 're-construction-installment', name: 'Construction Draw' },
                        { id: 're-registration', name: 'Recording Fee' },
                        { id: 're-stamp-duty', name: 'Transfer Tax' },
                        { id: 're-gst', name: 'Sales Tax' },
                        { id: 're-maintenance', name: 'HOA / Maintenance Fee' },
                        { id: 're-parking', name: 'Parking Fee' },
                        { id: 're-legal', name: 'Legal / Closing Costs' },
                        { id: 're-society', name: 'Club Membership Fee' },
                        { id: 're-interest', name: 'Interest / Late Fee' },
                        { id: 're-final', name: 'Final / Closing Payment' },
                    ],
                    addRowError: '',
