<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            <a href="{{ route('property-deals.index') }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200" title="{{ __('Back') }}">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">{{ $deal->property_title }}</h2>
        </div>
    </x-slot>
