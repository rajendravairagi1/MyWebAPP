    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('quotations.pdf', $quotation) }}" class="px-4 py-2 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-md hover:bg-gray-50 dark:hover:bg-slate-700">{{ __('Download PDF') }}</a>
                ...
                <script>document.addEventListener('DOMContentLoaded', function () { preloadPdf('{{ route('quotations.pdf', $quotation) }}'); });</script>
