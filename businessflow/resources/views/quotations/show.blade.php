    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                @if ($url = $quotation->whatsappShareUrl())
                    <a href="{{ $url }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700">
