@php
    ...
    // Only a paying business ever sees the support number — never the
    // public demo account, and never a page with no active business at
...
@endphp
<footer class="border-t border-gray-100 dark:border-slate-700 px-4 sm:px-6 lg:px-8 py-4 flex flex-wrap items-center justify-between gap-3 text-xs text-gray-400 dark:text-slate-500">
    <div>
