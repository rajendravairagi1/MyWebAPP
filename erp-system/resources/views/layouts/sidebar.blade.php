...
<aside x-data="{ mobileOpen: false }" class="lg:w-64 shrink-0">
    <!-- Mobile toggle -->
    <div class="lg:hidden flex items-center justify-between px-4 py-3 bg-[var(--sidebar-bg)] border-b border-white/10">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
            <x-application-logo class="h-7 w-auto fill-current text-[var(--sidebar-text)]" />
            <span class="font-semibold text-[var(--sidebar-text)]">ERP</span>
        </a>
        <button @click="mobileOpen = !mobileOpen" class="p-2 rounded-md text-[var(--sidebar-text)] hover:bg-white/5">
    ...
    <nav :class="{ 'block': mobileOpen, 'hidden': !mobileOpen }"
         class="hidden lg:block lg:sticky lg:top-0 lg:h-screen w-full lg:w-64 bg-[var(--sidebar-bg)] overflow-y-auto">
        <div class="hidden lg:flex items-center gap-2 px-6 py-5">
            <x-application-logo class="h-8 w-auto fill-current text-[var(--sidebar-text)]" />
            <span class="font-bold text-lg text-[var(--sidebar-text)]">Job Work ERP</span>
        </div>

        <div class="px-3 pb-6 space-y-6">
            <div>
                <p class="px-3 mb-2 text-[11px] font-semibold uppercase tracking-wider text-[var(--sidebar-text)] opacity-50">Menu</p>
                <div class="space-y-1">
            ...
            @role('Owner')
                <div>
                    <p class="px-3 mb-2 text-[11px] font-semibold uppercase tracking-wider text-[var(--sidebar-text)] opacity-50">Settings</p>
                    <div class="space-y-1">
