...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="address" rows="2" class="w-full rounded-md border-gray-300 shadow-sm text-sm">{{ old('address', $c?->address) }}</textarea>
    </div>
    <div>
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="notes" rows="2" class="w-full rounded-md border-gray-300 shadow-sm text-sm">{{ old('notes', $c?->notes) }}</textarea>
    </div>
    <div class="sm:col-span-2">
        <label class="block text-sm font-medium text-gray-700 mb-1">Documents Upload (GST cert, agreement, etc.)</label>
