...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    ...
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Source</label>
    ...
    <div>
        ...
        <select name="status" required class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">
    ...
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Assigned To</label>
        <select name="assigned_to" class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="notes" rows="3" class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">{{ old('notes', $l?->notes) }}</textarea>
    </div>
</div>
