...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Employee Code *</label>
    ...
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Name *</label>
    ...
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Joining Date</label>
        <input type="date" name="joining_date" value="{{ old('joining_date', $e?->joining_date?->format('Y-m-d')) }}"
               class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">
    </div>
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Aadhaar Number</label>
        <input type="text" name="aadhaar_number" value="{{ old('aadhaar_number', $e?->aadhaar_number) }}"
               class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">
    </div>
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">PAN Number</label>
    ...
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Designation</label>
        <input type="text" name="designation" value="{{ old('designation', $e?->designation) }}"
               class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">
    </div>
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Per-Day Salary (₹) *</label>
    ...
    <div>
        ...
        <select name="status" class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">
    ...
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Bank Account Number</label>
        <input type="text" name="bank_account_number" value="{{ old('bank_account_number', $e?->bank_account_number) }}"
               class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">
    </div>
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Bank IFSC</label>
