...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Supplier Name *</label>
    ...
    <div>
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Phone</label>
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="address" rows="2" class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">{{ old('address', $s?->address) }}</textarea>
    </div>
    <div class="sm:col-span-2">
        <label class="block text-sm font-medium text-[var(--muted)] mb-1">Notes</label>
        <textarea name="notes" rows="2" class="w-full rounded-md border-[var(--border)] shadow-sm text-sm">{{ old('notes', $s?->notes) }}</textarea>
    </div>
</div>
