...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    ...
    <div>
        ...
        <select name="unit" class="w-full rounded-md border-gray-300 shadow-sm text-sm">
    ...
    <div>
        ...
        <input type="number" step="0.01" name="low_stock_alert_at" value="{{ old('low_stock_alert_at', $m?->low_stock_alert_at ?? 0) }}" required
               class="w-full rounded-md border-gray-300 shadow-sm text-sm">
        <p class="text-xs text-gray-400 mt-1">Stock isse neeche jaate hi "Low Stock" dikhega.</p>
    </div>
</div>
